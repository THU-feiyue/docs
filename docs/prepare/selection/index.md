...
学校的 Title 是否好需要结合你的未来规划考虑：如果打算回国那需要考虑在国内的 title 以及各类大学排名，如果打算留外那直接考虑在当地的 reputation 即可。具体来说学校 title 影响着求职时的背景、校友网络、~~你爸妈出去吹牛是否有面~~ 等问题。不过通常来说学校 Title 是最后几个需要被考虑的因素（虽然比如 [ivy 其实是个体育联盟](https://en.wikipedia.org/wiki/Ivy_League) 但国内就认这个，或者是一些偏科学校的排名会很低），你自己水平够硬才是比较重要的。

## 项目导向

当然要挑选适合你未来职业规划的项目！可以通过往届学生去向、课程设置来了解。比如往届学生基本都大量实习最后去了业界 + 学校提供丰富的 career service + 处于产业发达的大城市 一般意味着适合就业导向；往届学生转申情况良好 + 课程硬度大理论性强 + 科研机会丰富教授指导多 一般意味着适合转博导向等。一般来说转博导向的项目时间会比较长。另外项目官网有时也会写明项目的导向，如果有的话你可以在撰写 SOP 时予以呼应。
...
-   美国：大城市 + 私立校 = 贵，以 NYC 的 Columbia 为例经常可以按照每年 80W rmb 预计总花费（学费 50 + 生活费 30 上不封顶）；公立校的学费一般会便宜，比如 UCB 可能只有 30W 学费，但加州生活费还是很贵；在村里的学校生活费会很便宜，比如玉米地可能只需要 20W 就能过的很滋润了。
-   英国：跟美国情况类似。
